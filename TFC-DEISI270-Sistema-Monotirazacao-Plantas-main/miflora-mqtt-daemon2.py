...
while True:
    ...
    channel_id = " 2118092"
    write_api_key = "458P1CH2KQH4OUAG"
    params = {
    ...
    if os.path.isfile('plants2.csv'):
        df.to_csv('plants2.csv',mode = 'a', index = False, header = False,)
    else :
        df.to_csv('plants2.csv',mode = 'a', index = False, header = True,)
    if daemon_enabled:
